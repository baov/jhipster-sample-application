package fr.baov.sampleapp.repository;

import fr.baov.sampleapp.JhipsterSampleApplicationApp;
import fr.baov.sampleapp.config.Constants;
import fr.baov.sampleapp.config.audit.AuditEventConverter;
import fr.baov.sampleapp.domain.PersistentAuditEvent;
...
import static fr.baov.sampleapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
